...
public abstract class EnsureTester<TEnsure, TGenerator> where TEnsure : EnsureBase<TGenerator>, new() where TGenerator : new()
{
    ...
    public void ValueEquality_WhenParameterlessAndReferenceEqualityReturnsFalseForSameReference_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects with the same reference should be equal.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndValueEqualityFail_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects with the same value should be equal.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndDifferentValuesReturnTrue_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects with different values should not be equal.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndDoubleNullEqualityFails_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Two nulls should always return true when compared with '=='.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndLeftIsNullButRightIsNotReturnsTrue_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("'Left' is null and 'Right' is not. They should not be considered equal when compared with '=='.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndRightIsNullButLeftIsNotReturnsTrue_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("'Right' is null and 'Left' is not. They should not be considered equal when compared with '=='.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndObjectsWithSameReferenceReturnsFalse_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Two objects with the same reference should be considered equal when compared with '=='.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndObjectsWithSameValueReturnsFalse_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects with the same value should be considered equal when compared with '=='.");
    }
    ...
    public void ValueEquality_WhenParameterlessAndObjectsWithDifferentValuesReturnTrue_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects with different values should not be considered equal when compared with '=='.");
    }
    ...
    public void ValueInequality_WhenParameterlessAndDoubleNullEqualityFails_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Two nulls should always return false when compared with '!='.");
    }
    ...
    public void ValueInequality_WhenParameterlessAndLeftIsNullButRightIsNotReturnsFalse_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("'Left' is null and 'Right' is not. This should be true when compared with '!='.");
    }
    ...
    public void ValueInequality_WhenParameterlessAndRightIsNullButLeftIsNotReturnsFalse_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("'Right' is null and 'Left' is not. This should be true when compared with '!='.");
    }
    ...
    public void ValueInequality_WhenParameterlessAndHasInproperValueEquality_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Same references should return false when compared with '!='.");
    }
    ...
    public void ValueInequality_WhenParameterlessAndInequalityAlwaysFalse_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects with different values should return true when compared with '!='.");
    }
    ...
    public void ValueEquality_WhenPassingGeneratorAndTNullEqualityReturnsTrue_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Objects should not be equal if one is null.");
    }
    ...
    public void Equality_BetweenDifferentObjects_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Was not considered equal using the Equals method.");
    }
    ...
    public void Equality_WhenEqualsOperatorHasBadValueEquality_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Was not considered equal using the '==' operator.");
    }
    ...
    public void Equality_WhenInequalityOperatorHasBadValueEquality_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Was expecting false with '!='.");
    }
    ...
    public void Inequality_BetweenSameValues_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Was expecting false using the Equals method.");
    }
    ...
    public void Inequality_WhenEqualsOperatorHasBadValueEquality_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Was expecting false using the '==' operator.");
    }
    ...
    public void Inequality_WhenInequalityOperatorHasBadValueEquality_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Was expecting true using the '!=' operator.");
    }
    ...
    public void ValueHashCode_WhenTwoDifferentObjectsProduceSameHashCode_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Two objects with different values should produce different hash code.");
    }
    ...
    public void ValueHashCode_WhenTwoDifferentObjectsWithSameValueDoNotProduceSameHashCode_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Two objects with the same value should produce the same hash code.");
    }
    ...
    public void ValueHashCode_WhenSameReferenceDoesNotProduceSameHashCode_Throw()
    {
        ...
        //Assert
        action.Should().Throw<AssertFailedException>().WithMessage("Two objects with the same reference should produce the same hash code.");
    }
